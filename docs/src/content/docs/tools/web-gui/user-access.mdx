...
User philipp.salvisberg+33@gmail.com has requested access to tenant demo.

You receive this e-mail because you are an administrator for this tenant.

Visit https://dblinter.app/ords/r/dblinter/dblinter-console/tenant-access to approve or reject this request.
