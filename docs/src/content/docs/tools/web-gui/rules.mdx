...
In this page you can query rules by the following search criteria:
...
| Free?         | Is the rule included in [Starter Subscription (Free)](/dbLinter/getting-started/starter-subscription/)? |
