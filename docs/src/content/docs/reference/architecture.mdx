...
However, it is recommended that you access the rules via the Web GUI, since you can easily log in and
add or remove rules from the configuration. Furthermore, you can manage private
(tenant-specific) rules in the same way. Here is the link to the same rule in the Web GUI:
[G-9601: Never user unknown hints](https://dblinter.app/ords/r/dblinter/dblinter-console/rules#P1000_SHOW_RULE=core%20g-9601).
