...
No. Only sessions used to analyse code are reserving seats.
...
| dbLinter Repo | On expiration of a session. This is a logical change based on the server time. Session are considered expired when the value of `Valid Until` is in the past. |
