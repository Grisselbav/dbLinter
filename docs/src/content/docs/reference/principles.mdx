...
A rule must not report anything that can be deduced by the compiler (PL/SQL stored objects, views or APEXlang files).
...
Exceptions:
  ...
  - Code which is buggy before applying a quick fix. A `to_date` call without format model violating the rule
    [G-9010: Always use a format model in string to date/time conversion functions](https://dblinter.app/ords/r/dblinter/dblinter-console/rules#P1000_SHOW_RULE=core%20g-9010), for example.
    ...
    issues (see [Improve Result with Database Access](#improve-result-with-database-access)).

  - Code which requires changes in other artifacts. The quick fix for
    [G-8210: Always use synonyms when accessing objects of another application schema](https://dblinter.app/ords/r/dblinter/dblinter-console/rules#P1000_SHOW_RULE=core%20g-8210)
  ...
  - Template quick fixes as first step in solving a problem. The quick fix `Add start label <<change_me>>.` for a violation of
    [G-1010: Try to label your sub blocks](https://dblinter.app/ords/r/dblinter/dblinter-console/rules#P1000_SHOW_RULE=core%20g-1010),
...
[G-9010: Always use a format model in string to date/time conversion functions](https://dblinter.app/ords/r/dblinter/dblinter-console/rules#P1000_SHOW_RULE=core%20g-9010)
...
For example [G-3330: Avoid autonomous transactions](https://dblinter.app/ords/r/dblinter/dblinter-console/rules#P1000_SHOW_RULE=core%20g-3330)
