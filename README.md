...
- [G-4330: AAlways use a CURSOR FOR loop to process the complete cursor results unless you are using bulk operations.](https://dblinter-rules.united-codes.com/rules/G-4330)
